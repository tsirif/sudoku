...
PROB_DIR="${ROOT_DIR}/checkpoints_absorbing"
CHECKPOINTS=(
  "best_model.pt"
...
DEVICE="${DEVICE:-cuda}"
PROJECT="${PROJECT:-sudoku_eval_absorbing_only_nov22}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/eval_results_absorbing_only_nov22}"
