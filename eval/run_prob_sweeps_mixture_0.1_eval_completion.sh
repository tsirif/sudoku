...
PROB_DIR="${ROOT_DIR}/uniform_absorbing_mixture_checkpoints/prob_0.1"
CHECKPOINTS=(
  "best_model.pt"
...
DEVICE="${DEVICE:-cuda}"
PROJECT="${PROJECT:-sudoku_eval_prob_0.1_absorbing_only_nov22}"
OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/eval_results_prob_0.1_absorbing_only_nov22}"
